...
<main>
    <div class="headline-productlist">
        ...
        <p class="intro-text">
            <?php the_field("intro_text") ?> <br> <a href="/kontakt" class="produkt-kontakt" target=”_blank”>Kontakt
                os</a> gerne for mere information.
        </p>
    </div>

    <article class="content-productlist">
        <?php $productLoop = new WP_Query(array("post_type" => "vindue", "posts_per_page" => -1, "order" => "ASC")); ?>
